%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Description: 
%           Visualize and return a printable eight-band multispectral image.
% 
% Interface:
%           showImage8(I_MS,id,flag_cut_bounds,dim_cut,th_values,L)
%
% Inputs:
...
%           IMN:                printable image
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function IMN = showImage8(I_MS,id,flag_cut_bounds,dim_cut,th_values,L)
