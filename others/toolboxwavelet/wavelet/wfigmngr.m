    ...
    case 'print'
        ...
        switch item
            case {1,2}
                ...
                par = cat(1,par{:});
                [P1,I,J] = unique(par);
                bool = strncmpi('Of',get(P1,'Visible'),2);
                while ~isequal(P1,fig*ones(size(I)))
                    P1 = get(P1,'Parent');
                    P1 = cat(1,P1{:});
                    P1(P1==0) = fig;
                    bool = bool | strncmpi('Of',get(P1,'Visible'),2);
                end
                bool = bool(J);                
                ...
                bool_uit = strncmpi('Of',get(par,'Visible'),2);
...
if isempty(find(wfindobj('figure')==fig,1)) , fig = gcf; end
