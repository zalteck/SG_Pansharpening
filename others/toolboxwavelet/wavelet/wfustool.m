...
%   $Revision: 1.1.6.19 $ $Date: 2012/12/03 01:57:42 $ 
...
%-------------------------------------------------------------------------
wguiutils('setAxesTitle',handles.Axe_Image_1, ...
    getWavMSG('Wavelet:divGUIRF:Image_X',1),hObject);
wguiutils('setAxesTitle',handles.Axe_Image_2, ...
    getWavMSG('Wavelet:divGUIRF:Image_X',2),hObject);
wguiutils('setAxesXlabel',handles.Axe_Image_Fus, ...
    getWavMSG('Wavelet:commongui:Syn_Img'),hObject);
wguiutils('setAxesTitle',handles.Axe_ImgDec_1, ...
    getWavMSG('Wavelet:divGUIRF:Decomposition_X',1),hObject);
wguiutils('setAxesTitle',handles.Axe_ImgDec_2, ...
    getWavMSG('Wavelet:divGUIRF:Decomposition_X',2),hObject);
wguiutils('setAxesXlabel',handles.Axe_ImgDec_Fus, ...
    getWavMSG('Wavelet:divGUIRF:FusionOfDec'),hObject);
%-------------------------------------------------------------------------
