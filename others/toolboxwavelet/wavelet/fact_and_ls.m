...
%   $Revision: 1.1.6.6 $ $Date: 2012/06/03 06:27:06 $ 
...
disp(getWavMSG('Wavelet:moreMSGRF:FactLS_MSG_3',sprintf('%3.0f',find(errFlags==0))));
disp(getWavMSG('Wavelet:moreMSGRF:FactLS_MSG_4',sprintf('%12.8f',errTAB(errFlags==0))));
