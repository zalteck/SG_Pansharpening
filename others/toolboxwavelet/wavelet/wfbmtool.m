...
%   $Revision: 1.1.6.13 $  $Date: 2012/03/01 03:09:49 $ 
...
wguiutils('setAxesTitle',handles.Axe_FBM,FBM_title);
...
wguiutils('setAxesTitle',handles.Axe_FBM,title,hObject);

% Set Title in the 1Dif axes (first time).
%-----------------------------------------
title = getWavMSG('Wavelet:divGUIRF:First_OrdInc');
wguiutils('setAxesTitle',handles.Axe_1Dif,title,hObject);
