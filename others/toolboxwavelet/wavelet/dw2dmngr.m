...
%   $Revision: 1.24.4.18 $ $Date: 2012/12/03 01:57:36 $
...
switch option
    ...
    case 'save_cfs'
        ...
        %-------------------------
        [wname,valTHR] = wmemtool('rmb',win_dw2dtool,n_param_anal, ...
                               ind_wav_name,ind_thr_val); %#ok<ASGLU,NASGU>
        ...
        coefs = wmemtool('rmb',win_dw2dtool,n_coefs,1); %#ok<NASGU>
        sizes = wmemtool('rmb',win_dw2dtool,n_sizes,1); %#ok<NASGU>
