...
%   $Revision: 1.10.4.8 $ $Date: 2012/06/03 06:27:40 $
...
try callHelpViewer(tag);
    ...
    msg = {'' ; getWavMSG('Wavelet:divGUIRF:Err_HelpLine',tag); ''};
    if isempty(docroot),
        msg = [msg;getWavMSG('Wavelet:moreMSGRF:HLP_DOCROOT_1')];
    else
        msg = [msg;getWavMSG('Wavelet:moreMSGRF:HLP_DOCROOT_2')];
    end
    msg = [msg;getWavMSG('Wavelet:moreMSGRF:HLP_DOCROOT_3')];
