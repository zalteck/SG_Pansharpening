...
%   $Revision: 1.18.4.14 $ $Date: 2012/06/03 06:27:04 $
...
if isempty(find(wfindobj('figure')==fig,1)) , return; end
format = '%20.15f';
    ...
    case {'Install_V3','Install_V3_CB','create','create_V3'}
        ...
        switch option            
            ...
            case 'Install_V3_CB'
                ...
                set(handles.Edi_Center     ,'Callback',['dynvtool(''edi_center'',gcbf,' ediStr ')'])                
...
[ediActBkColor,ediInActBkColor,fraBkColor,uicFontSize] = ...
    mextglob('get','Def_Edi_ActBkColor',...
