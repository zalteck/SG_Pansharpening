...
%   $Revision: 1.1.6.10 $  $Date: 2012/03/01 03:09:48 $ 
...
wguiutils('setAxesTitle',handles.Axe_xDif,title,hObject);
...
wguiutils('setAxesTitle',axe_xdif,label);
...
wguiutils('setAxesTitle',axe_hist,label);
...
wguiutils('setAxesTitle',axe_cumhist,label);
...
wguiutils('setAxesTitle',axe_corr,label);
...
wguiutils('setAxesTitle',axe_spec,label);
%--------------------------------------------------------------------------
