...
%   $Revision: 1.1.6.4 $ $Date: 2011/04/12 20:46:01 $ 
...
if nbFACT>0
    switch factMode
        case 't' ,
            ...
            [~,dual_errFlags] = errlsdec(dual_LS,tolerance);
            [~,prim_errFlags] = errlsdec(prim_LS,tolerance);
        ...
        case {'d','p'} ,  % dual_LS or prim_LS
            ...
            % Control of the factorizations.
            [~,errFlags] = errlsdec(LS,tolerance);
            LS = LS(errFlags);
            varargout = LS;
