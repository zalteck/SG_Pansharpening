...
%      dt:      sampling period.
%
%   With XREC = ICWTFT(...,'plot') the reconstructed signal from
%   the continuous wavelet coefficients is plotted.
%
%   In addition, with XREC = ICWTFT(...,'signal',SIG,'plot') the  
%   original signal is superimposed.
%
%   SIG can be a vector, a structure or a cell array.
%   If SIG is a vector, it contains the values of the original 
%   analyzed signal. 
%   If SIG is a structure, SIG.val and SIG.period contain
%   respectively the values and the sampling period of the   
%   signal. 
...
%   $Revision: 1.1.6.6 $ $Date: 2012/06/03 06:27:09 $
