...
%         idx = strcmp(tag,'Edi_TIT_PAN_ENERGY');
%         set(uic(idx),'String',getWavMSG('Wavelet:mdw1dRF:Ener_EnerRat'));
...
%         set(uic(idx),'String',getWavMSG('Wavelet:mdw1dRF:Edi_TIT_Dendro_Graph'));
        ...
        set(pan(idx),'title',getWavMSG('Wavelet:mdw1dRF:Data_to_Cluster'));
...
%         idx = strcmp(tag,'Edi_TIT_MAN');
%         set(uic(idx),'String',getWavMSG('Wavelet:mdw1dRF:Edi_TIT_MAN')); 
...
%         idx = strcmp(tag,'Edi_TIT_STA');
%         set(uic(idx),'String',getWavMSG('Wavelet:mdw1dRF:Edi_TIT_STA'));
        ...
        set(pan(idx),'title',getWavMSG('Wavelet:mdw1dRF:Pan_STA_VAL'));
    ...
    case 'wmuldentool'
        ...
        set(pan(idx),'title',['  ' getWavMSG('Wavelet:mdw1dRF:Rad_BASE_ADAP') '  '])
        idx = strcmp(tagPAN,'Pan_RESIDUALS');
        set(pan(idx),'title',['  ' getWavMSG('Wavelet:commongui:Str_Residuals') '  '])
        idx = strcmp(tagPAN,'Pan_BASE_ORI');
        set(pan(idx),'title',['  ' getWavMSG('Wavelet:mdw1dRF:Rad_BASE_ORI') '  '])
        idx = strcmp(tagPAN,'Pan_RES_STATS');
        set(pan(idx),'title',getWavMSG('Wavelet:commongui:Str_Residuals'))        
        idx = strcmp(tagPAN,'Pan_DEN_PARAM');
        set(pan(idx),'title',['  ' getWavMSG('Wavelet:mdw1dRF:Txt_Den_Par') '  '])        
...
switch callingTool
    case {'mdw1dtool','mdw1dclus','mdw1dcomp','mdw1ddeno','mdw1dstat'}
        idx = strcmp(tag,'Txt_Wav');
        set(uic(idx),'String',getWavMSG('Wavelet:commongui:Str_Wavelet'));
%         idx = strcmp(tag,'Edi_TIT_VISU');
%         set(uic(idx),'String',getWavMSG('Wavelet:mdw1dRF:Edi_TIT_VISU')); 
        idx = strcmp(tagPAN,'Pan_VISU_SIG');
        set(pan(idx),'title', ...
            formatPanTitle(getWavMSG('Wavelet:mdw1dRF:Edi_TIT_VISU')));
%         idx = strcmp(tag,'Edi_TIT_SEL');
%         set(uic(idx), ...
%             'String',getWavMSG('Wavelet:mdw1dRF:Edi_TIT_SEL'), ...
%             'TooltipString',getWavMSG('Wavelet:mdw1dRF:Tip_Edi_TIT_SEL')  ...
%             );
