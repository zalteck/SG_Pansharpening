...
%   $Revision: 1.1.6.10 $ $Date: 2012/06/03 06:28:42 $ 
...
wguiutils('setAxesTitle',axe_SIG(1), ...
    getWavMSG('Wavelet:mdw1dRF:Str_Signals'));
...
t = wguiutils('setAxesTitle',axe_SIM(1), ...
    getWavMSG('Wavelet:mdw1dRF:Simp_Signals'));
set(t,'Tag','Simp_Signals');
...
switch state
    case 0
        ...
        t = wguiutils('setAxesTitle',axe_RES(1), ...
            getWavMSG('Wavelet:commongui:Str_Residuals'));
        set(t,'Tag','Residuals');
        t = wguiutils('setAxesTitle',axe_HIS(1), ...
            getWavMSG('Wavelet:commongui:Str_HIST'));
        set(t,'Tag','Histograms');
        t = wguiutils('setAxesTitle',axe_CUM(1), ...
            getWavMSG('Wavelet:commongui:Str_CumHistS'));
        set(t,'Tag','CumHistograms');
...
wguiutils('setAxesTitle',axe_CFS(1),...
    getWavMSG('Wavelet:commongui:Str_Coefficients'));
dynvtool('init',hFig,[],axe_CMD,[],[1 0],'','','','real');
%--------------------------------------------------------------------------
...
switch typeCALL
    ...
    case 'beg_dec'
        ...
        UIC_Ena_ON = [...
            handles.Pus_Decompose,handles.Txt_PCA_Par,hdl_ON, ...
