...
%   $Revision: 1.1.6.11 $ $Date: 2012/06/03 06:28:43 $  
...
wguiutils('setAxesTitle',axe_DEN(1),getWavMSG('Wavelet:mdw1dRF:DenoSig'));
%++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
wguiutils('setAxesTitle',axe_DEN_A(1),getWavMSG('Wavelet:mdw1dRF:DenoSig'));
%++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
axe_IND = [];
axe_CMD = [axe_SIG,axe_CFS,axe_DEN];
axe_ACT = [];
...
switch state
    case 0
        ...
        wguiutils('setAxesTitle',axe_RES(1), ...
            getWavMSG('Wavelet:commongui:Str_Residuals'));
        wguiutils('setAxesTitle',axe_HIS(1), ...
            getWavMSG('Wavelet:commongui:Str_HIST'));
        wguiutils('setAxesTitle',axe_CUM(1), ...
