...
%   $Revision: 1.1.6.6 $ $Date: 2012/06/03 06:28:38 $ 
...
set(handles.Edi_TIT_GRA_SIM,'String',idxNAME);
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
for j=1:nbPART
    txt_LIN_V(j) = line('XData',[j,j],'YData',[0,NbCLU_MAX],...
        'LineWidth',LW,'Color',Col_LIN_V,'Parent',axeCUR);
end
txt_LIN_H = zeros(1,NbCLU_MAX);
if nbPART>1
    for j=1:NbCLU_MAX
        txt_LIN_H(j) = line('YData',[j,j],'XData',[0,nbPART],...
