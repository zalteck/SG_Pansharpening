...
%   Last Revision: 27-Mar-2012.
%   Copyright 1995-2012 The MathWorks, Inc.
%   $Revision: 1.1.6.8 $ $Date: 2012/04/20 19:48:26 $
...
switch option
            ...
            case {'decCfs','lvlThr'}      % Decomposition Mode
                ...
                for k=level_DEC:-1:1
                    ...
                    if thrMode && thr_MAN_MODE
                        ...
                        paramVAL = [axe_Act ; nbTHR ; idxSIG_SEL(:) ; ...
                            uic_MAN(:)];
                        paramSTR  = num2mstr(paramVAL);
    ...
    case 'Line_Down_GRAPH'
        ...
        paramSTR = ...
            num2mstr([paramVAL(1);lin_U;lin_D;paramVAL(2:end);txtLIN(:)]);
