...
% Last Modified by GUIDE v2.5 12-Jan-2006 11:46:16
%
%   M. Misiti, Y. Misiti, G. Oppenheim, J.M. Poggi 06-Jan-2006.
%   Last Revision: 25-Jan-2012.
%   Copyright 1995-2012 The MathWorks, Inc.
%   $Revision: 1.1.6.5 $ $Date: 2012/03/01 03:10:50 $ 
...
txt = wfindobj(uic,'Style','text');
idx = strfind(get(txt,'String'),'Final');
if isempty(idx{1})
    idxdet = 1; idxfin = 2;
else
    idxdet = 2; idxfin = 1;
end
set(txt(idxdet),'String',getWavMSG('Wavelet:mdw1dRF:Nb_PC_DetOrApp'));
set(txt(idxfin),'String',getWavMSG('Wavelet:mdw1dRF:Nb_PC_FinalPCA'));
pus_MORE   = varargin{1};
