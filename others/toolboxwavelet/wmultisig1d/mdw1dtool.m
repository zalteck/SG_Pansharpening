...
%   Last Revision: 11-Sep-2012.
%   Copyright 1995-2012 The MathWorks, Inc.
%   $Revision: 1.1.6.15 $ $Date: 2012/10/15 20:15:26 $
...
set(handles.Edi_TIT_VISU_DEC,'String', ...
    getWavMSG('Wavelet:mdw1dRF:View_Decompositions'))
...
switch option
    case 'load'
        ...
        set([handles.Edi_TIT_VISU,handles.Edi_TIT_SEL,...
             handles.Edi_TIT_VISU_DEC, handles.Edi_TIT_PAN_INFO],...
             'Enable','Inactive')
        titleSTR = getWavMSG('Wavelet:mdw1dRF:Info_SelData');
        ...
        set(UIC_Ena_ON,'Enable','On')       
        UIC_Ena_INA = ...
            [handles.Edi_TIT_SEL,handles.Edi_TIT_VISU,handles.Txt_SORT,...
...
if nbSIG>1
    ...
    set(handles.Edi_TIT_PAN_ENERGY,'String',pan_Title,'Visible','On');
