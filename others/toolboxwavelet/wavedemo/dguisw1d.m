...
%DGUISW1D Shows 1-D SWT de-noising wavelet GUI tools in the Wavelet Toolbox.
%
...
%   $Revision: 1.7.4.4 $  $Date: 2012/06/13 09:32:11 $
...
if nargin>0
	...
	switch action
	  ...
	  case 'getFigParam'
		  figName  = getWavMSG('Wavelet:wavedemoMSGRF:DGUI_SW1D');
		  showType = 'command';
